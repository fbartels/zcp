...
/*
 * The full checks _need_ to be done, do _NOT_ attempt to shortcut this.
 * "result = (a - b)" is totally wrong. It can lead to underflow
 * and falsify the result. (Consider: short a=-16385, b=16385;)
 */
